...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s superdigitalcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  superdigitalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded superdigitalcoin transaction") + "\n" +
              "  superdigitalcoin-tx [options] -create [commands]   " + _("Create hex-encoded superdigitalcoin transaction") + "\n" +
              "\n";
