...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/superdigitalcoin-project/superdigitalcoin>";
    const std::string URL_WEBSITE = "<https://superdigitalcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("SuperDigitalCoin version %s\n", FormatFullVersion());
}
