...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000000042b1dcc521");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x52c28e9c6afdfd3840f93bf1a45fa02f20f9d17fdb5e470f4e5baf8fe9071b0e"); //176418
        ...
        vSeeds.push_back(CDNSSeedData("seed.superdigitalcoin.org", "18.191.71.29"));
        vSeeds.push_back(CDNSSeedData("seedjapan.superdigitalcoin.org", "54.178.231.122"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (102400, uint256S("0x5a3f4eac198703b50cb2f29be724bee361106f1b9463ad1776ae7f43059ccae9"))
            (204800, uint256S("0xa5a634772b99297ffe7183991de59184dd149dfb896bf531f699db53d45d2d20"))
            (270000, uint256S("0xb8639792c87f299ac3e8b8e1e5f848964afdb836091ce78dceac5ea0e5c9d74c"))
        };
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("superdigitalcoin.org", "testnet-seed.superdigitalcoin.org"));
